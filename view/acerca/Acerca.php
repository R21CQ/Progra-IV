<!-- CSS -->
<link rel="stylesheet" href="archivos/css/estiloAcerca.css" type="text/css"/>
...
<div class="col-md-12" id="descripcion">    
    ...
    <div class="col-md-8">
        ...
        <h3>Somos una empresa que brinda servicios en venta de bicletas de la línea básica, 
            media y profesional, tambien contamos con repuestos y variedad de accesorios 
            deportivos de Ciclismo, realizamos revisiones y reparaciones de Bicicletas.
        </h3>
    </div>
</div>